...
#include "OpenFOAM-2.1.x/src/finiteVolume/fvMesh/extendedStencil/cellToFace/fullStencils/FECCellToFaceStencil.H"
...
#include "OpenFOAM-2.1.x/src/OpenFOAM/meshes/polyMesh/syncTools/dummyTransform.H"
