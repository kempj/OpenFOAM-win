...
#include "OpenFOAM-2.1.x/src/finiteVolume/finiteVolume/laplacianSchemes/laplacianScheme/laplacianScheme.H"

#include "OpenFOAM-2.1.x/src/OpenFOAM/primitives/one/one.H"//JK
