...
#include "OpenFOAM-2.1.x/src/meshTools/sets/cellSources/fieldToCell/fieldToCell.H"
...
#include "OpenFOAM-2.1.x/src/meshTools/sets/cellSources/fieldToCell/fieldDictionary.H"
